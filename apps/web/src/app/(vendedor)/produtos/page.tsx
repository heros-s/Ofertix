      ...
      <header className="border-b border-slate-200 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Link href="/dashboard" className="text-xl font-bold tracking-tight text-slate-900 hover:text-indigo-600 transition-colors">
              Ofertix Vendedor
            </Link>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/produtos/novo"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-sm shadow-md hover:shadow-indigo-600/10 transition-all duration-200"
            >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        {products.length === 0 ? (
          <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center shadow-sm max-w-xl mx-auto space-y-6 mt-8">
            ...
            <Link
              href="/produtos/novo"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-sm shadow-md transition-all duration-200"
            >
                      ...
                      <tr key={product.id} className="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="py-4 px-6 text-right flex items-center justify-end gap-2">
                          <Link
                            ...
                            className="inline-flex items-center gap-1 p-2 border border-slate-200 hover:border-indigo-600 hover:bg-indigo-50 text-slate-600 hover:text-indigo-600 rounded-lg text-xs font-semibold transition-all duration-200"
